...
#include "Features/ScWGFA_AddWidget.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(ScWGFA_AddWidget)
...
void UScWGFA_AddWidgets::AddAdditionalAssetBundleData(FAssetBundleData& AssetBundleData)
{
...
void UScWGFA_AddWidgets::AddToWorld(const FWorldContext& WorldContext, const FGameFeatureStateChangeContext& ChangeContext)
{
	...
	if ((GameInstance != nullptr) && (World != nullptr) && World->IsGameWorld())
	{
		...
		{			
			TSoftClassPtr<AActor> HUDActorClass = AScWHUD::StaticClass();
...
void UScWGFA_AddWidgets::Reset(FPerContextData& ActiveData)
{
...
void UScWGFA_AddWidgets::AddWidgets(AActor* Actor, FPerContextData& ActiveData)
{
	AScWHUD* HUD = CastChecked<AScWHUD>(Actor);
...
void UScWGFA_AddWidgets::RemoveWidgets(AActor* Actor, FPerContextData& ActiveData)
{
	AScWHUD* HUD = CastChecked<AScWHUD>(Actor);
