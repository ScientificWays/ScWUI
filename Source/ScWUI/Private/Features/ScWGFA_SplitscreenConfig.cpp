...
#include "Features/ScWGFA_SplitscreenConfig.h"

#include "Engine/GameInstance.h"
#include "Engine/GameViewportClient.h"
#include "Features/ScWGFA_WorldActionBase.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(ScWGFA_SplitscreenConfig)
...
void UScWGFA_SplitscreenConfig::AddToWorld(const FWorldContext& WorldContext, const FGameFeatureStateChangeContext& ChangeContext)
{
